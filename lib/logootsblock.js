...
LogootSBlock.fromJSON = function (o) {
		...
		console.assert(typeof o.id === "object");
		console.assert(o.id.base instanceof Array);
		console.assert(typeof o.begin === "number");
		console.assert(typeof o.end === "number");
		console.assert(typeof o.nbElement === "number");
