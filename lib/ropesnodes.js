...
RopesNodes.fromJSON = function (node) {
 	return new RopesNodes({
		...
		block: (node.block != null) ? LogootSBlock.fromJSON(node.block) : null,
		left: (node.left != null) ? RopesNodes.fromJSON(node.left) : null,
		right: (node.right != null) ? RopesNodes.fromJSON(node.right) : null,
	});
};
