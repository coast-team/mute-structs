...
LogootSRopes.prototype.getBlock = function (id) {
    var ret = this.mapBaseToBlock[id.base];
    if(ret==null) {
        ret = new LogootSBlock(id);
        this.mapBaseToBlock[id.base] = ret;
    }
    return ret;
};
...
LogootSRopes.prototype.addBlock = function (args) {
    if(args['idi'] != null
        ...
        if (this.root == null) {
            ...
            this.mapBaseToBlock[bl.id.base] = bl;
            var args2 = {
                        'length': str.length,
                        'offset': id.last,
                        'block': bl
...
LogootSRopes.prototype.mkNode = function (id1, id2, length) {
    ...
    this.mapBaseToBlock[idi.base] = newBlock;
    var args = {
        'length': length,
        'offset': 0,
        'block': newBlock
...
LogootSRopes.prototype.delNode = function (path) {
    ...
    if (node.block.nbElement == 0) {
        this.mapBaseToBlock[node.block.id.base]=null;
    }
    if (node.right == null) {
        if (node == this.root) {
            this.root = node.left;
