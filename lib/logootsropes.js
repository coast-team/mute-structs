...
LogootSRopes.prototype.getBlock = function (id) {
    var ret = this.mapBaseToBlock[id.base.join(",")];
    if (ret === null) {
        ret = new LogootSBlock(id);
        this.mapBaseToBlock[id.base.join(",")] = ret;
    }
    return ret;
};
