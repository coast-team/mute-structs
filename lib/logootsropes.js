...
LogootSRopes.prototype.mkNode = function (id1, id2, length) {
    console.assert(id1 === null || id1 instanceof Identifier);
    console.assert(id2 === null || id2 instanceof Identifier);
...
LogootSRopes.prototype.copyFromJSON = function(ropes) {
    ...
    console.assert(ropes.root === null || typeof ropes.root === "object");
    console.assert(typeof ropes.mapBaseToBlock === "object");
    console.assert(typeof ropes.str === "string");
